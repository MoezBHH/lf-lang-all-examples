...
#include "include/TemperatureSensor_MQTT/TempSensor.h"
...
void _tempsensorreaction_function_0(void* instance_args) {
    ...
    #line 37 "/home/moez/AccountableAI/LFGPT/playground-lingua-franca/examples/C/src/cody-code/TemperatureSensor_MQTT.lf"
    srand(time(NULL));
}
...
void _tempsensorreaction_function_1(void* instance_args) {
    _tempsensor_self_t* self = (_tempsensor_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _tempsensor_temp_t* temp = &self->_lf_temp;
    #line 42 "/home/moez/AccountableAI/LFGPT/playground-lingua-franca/examples/C/src/cody-code/TemperatureSensor_MQTT.lf"
